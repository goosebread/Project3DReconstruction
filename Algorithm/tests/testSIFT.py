...
class TestSIFT(unittest.TestCase):
    ...
    def testFeatureMatching(self):
        imgPath1 = os.path.join(projectPath,'Algorithm','tests','brian_voxels.png')
        imgPath2 = os.path.join(projectPath,'Algorithm','tests','brian_voxels2.png')
        ...
        cv.imwrite('sift_match.jpg',finalImg)
    ...
    # def testImage1OpponentSift(self):
    #     imgPath = os.path.join(projectPath,'Algorithm','tests','brian_voxels.png')
    #     img = cv.imread(imgPath)
    #     kp, des = opponentSIFT(img)
    ...
    def testOpponentSiftFeatureMatching(self):
        imgPath1 = os.path.join(projectPath,'Algorithm','tests','brian_voxels.png')
        imgPath2 = os.path.join(projectPath,'Algorithm','tests','brian_voxels2.png')
        ...
        kp1, des1  = opponentSIFT(img1)
        kp2, des2  = opponentSIFT(img2)
        ...
        cv.imwrite('opponentSift.jpg',finalImg)
